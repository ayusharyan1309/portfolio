export const personalInfo = {
  ...
  // Grouped to match the resume / Naukri / LinkedIn skill ordering: backend and
  // distributed-systems first, AI/ML second. Keep these three in sync —
  ...
  skills: {
    ...
    backend: [
      ...
      { name: 'Hibernate', logo: 'https://www.vectorlogo.zone/logos/hibernate/hibernate-ar21.svg' },
    ...
    dataBadges: ['Liquibase', 'Redis Caching', 'Schema Migrations'],
    cloud: [
    ...
    cloudBadges: ['AWS EC2 & S3', 'CI/CD', 'Spring Actuator'],
    aiMl: [
  ...
  '@graph': [
    {
      ...
      knowsAbout: [
        ...
        'Event-Driven Architecture', 'gRPC', 'REST API Design', 'WebSocket',
        'Spring Cloud Gateway', 'Hibernate', 'JPA', 'Liquibase',
        'MongoDB', 'MySQL', 'Elasticsearch', 'Firebase',
        'AWS', 'Amazon EC2', 'Amazon S3', 'Docker', 'Jenkins', 'CI/CD',
        'Prometheus', 'Grafana',
        'Computer Vision', 'MediaPipe', 'Machine Learning', 'Deep Learning',
        'Natural Language Processing', 'RAG (Retrieval-Augmented Generation)',
        'Large Language Models', 'LangChain', 'LangChain4j', 'Hugging Face',
        'PyTorch', 'TensorFlow', 'OpenAI API', 'Vector Search',

...
export function buildKnowledgeBase(): KnowledgeChunk[] {
  ...
  chunks.push({
    ...
    category: 'About',
    content:
      "Ayush Aryan is a high-impact backend engineer who ships fast and builds scalable event-driven systems for platforms supporting 100K+ concurrent users. He has 1.5+ years of full-time software engineering experience, a B.Tech from BML Munjal University, and startup experience. He brings a product builder mindset — he doesn't just write code, he owns outcomes end-to-end.",
  })
  chunks.push({
    id: 'about-specialization',
    category: 'About',
    content:
      'Ayush specializes in Java, Spring Boot, Apache Kafka, Redis, gRPC, Microservices Architecture, Computer Vision, GenAI/RAG, LLMs, and Distributed Systems. He builds production systems that move fast and scale hard.',
  })
  chunks.push({
    id: 'about-location',
    category: 'About',
  ...
  chunks.push({
    ...
    content:
      "Ayush ships fast — 4 apps shipped to production, from concept to App Store in under 4 months. He owns production services processing 10K+ safety events per day.",
  })
  chunks.push({
    id: 'why-builds-scalable',
    category: 'Why Hire Me',
    content:
      'Ayush builds scalable systems — event-driven microservices for platforms with 100K+ concurrent users, with Kafka and Redis pipelines holding end-to-end API latency under 150ms at peak.',
  })
  chunks.push({
  ...
  chunks.push({
    ...
    category: 'Why Hire Me',
    content:
      "Ayush is full-stack capable — strong backend core (Java, Spring Boot, Kafka, gRPC) plus GenAI (RAG, LLMs, LangChain4j) and mobile development (Flutter, 2 App Store launches).",
  })
  ...
  chunks.push({
    ...
    content:
      'At Visionify, Ayush is building PalletVision end-to-end with full ownership of the computer-vision detection model, the backend services, and the frontend. PalletVision is a computer-vision product for the pallet manufacturing industry that tracks pallets being built and dismantled in real time, generating productivity, grading, and dimensional analytics for pallet manufacturing teams.',
  })
  chunks.push({
    ...
    content:
      'At Visionify, Ayush built ErgoVision, a mobile computer-vision app that analyzes worker body posture in real time and uses GenAI to deliver personalized ergonomic improvement recommendations.',
  })
  chunks.push({
    id: 'exp-eventstrat',
    category: 'Experience',
    ...
    content:
      "At EventStrat, Ayush architected backend microservices for a global event-CRM platform supporting 100K+ concurrent users across international events. He constructed a fault-tolerant bulk data-ingestion pipeline (50K+ rows per file, 2K+ files per batch) with schema validation and automatic retries. He built exhibitor payment workflows supporting multi-installment plans, event-specific tax calculation, and automated payment reminders. He enabled real-time notifications and attendee tracking with a distributed, event-driven architecture on Kafka and Redis.",
  })
  chunks.push({
    id: 'exp-sneaco',
    category: 'Experience',
  ...
  chunks.push({
    ...
    category: 'Skills',
    content:
      'Ayush Aryan works with these languages and databases: Java, C, Python, SQL, Dart/Flutter, HTML5, CSS3, MySQL, Firebase, MongoDB, Elasticsearch, Redis, and Apache Kafka.',
  })
  chunks.push({
    id: 'skills-frameworks',
    category: 'Skills',
    content:
      'Ayush uses these frameworks, libraries, and infrastructure: Spring Boot, Node.js, gRPC, WebSockets, Hibernate/JPA, Docker, AWS (EC2, S3), Jenkins CI/CD, Spring Cloud Gateway, Eureka, OpenFeign, Resilience4j, Prometheus, Grafana, OpenCV, and Scikit-learn.',
  })
  chunks.push({
    id: 'skills-aiml',
    category: 'Skills',
    content:
      "Ayush's AI and Machine Learning expertise includes: Computer Vision (real-time detection models in production at Visionify), RAG (Retrieval-Augmented Generation), LLM integration, LangChain4j, embeddings and vector search (Cloudflare Workers AI), PyTorch, TensorFlow, LangChain, Hugging Face, OpenAI API, Natural Language Processing, and Deep Learning.",
  })
  chunks.push({
    id: 'skills-tools',
    category: 'Skills',
  ...
  chunks.push({
    ...
    category: 'Projects',
    content:
      'Ayush built the AI Portfolio Assistant — this very portfolio site with an integrated RAG chatbot that answers recruiter questions about his work. It retrieves over embedded resume and project documents using Cloudflare Workers AI embeddings and vector similarity search, deployed on a zero-cost serverless stack with Vercel and Cloudflare Workers. GitHub: https://github.com/ayusharyan1309/portfolio. Live: https://ayush-aryan1309-portfolio.vercel.app',
  })
  chunks.push({
    id: 'project-ltxgo',
    category: 'Projects',
    content:
      'Ayush built the LTXGO Ride Operations Platform — backend services for booking, dispatch, and multi-vehicle ride orchestration using Spring Boot, MySQL, JPA/Hibernate, and Liquibase. It features real-time ride tracking and notifications via WebSocket, Firebase FCM, and Redis-backed asynchronous workflows, with Flutter mobile and React CRM clients.',
  })
  chunks.push({
    id: 'project-microservices-ecommerce',
    category: 'Projects',
    content:
      'Ayush built a Microservices E-Commerce backend using Spring Boot 3.3. Features three independent services — product (MongoDB), order (MySQL), and inventory (MySQL) — with REST APIs, DTO patterns, JPA/Hibernate, and Testcontainers integration testing. GitHub: https://github.com/ayusharyan1309/microservices-based-E-Commerce-app',
  })
  chunks.push({
    id: 'project-chat-app',
    category: 'Projects',
    content:
      'Ayush built a full-featured real-time Chat App Backend with Spring Boot 3.5 and Java 17 featuring Firebase authentication, WebSocket (STOMP over SockJS) messaging, Apache Kafka event-driven architecture, MySQL with Liquibase migrations, and AWS S3 integration. Includes REST + WebSocket APIs for messaging, typing indicators, conversation management, and paginated history. GitHub: https://github.com/ayusharyan1309/chat-app-backend',
  })
  chunks.push({
    id: 'project-rainfall',
    category: 'Projects',
  ...
  chunks.push({
    ...
    category: 'Projects',
    content:
      'Ayush built an E-Commerce App — a full-stack marketplace app built with Flutter, Node.js, and MongoDB with REST APIs, user authentication, and product management. GitHub: https://github.com/ayusharyan1309/E-CommerceApp',
  })
  ...
  chunks.push({
    ...
    category: 'Contact',
    content:
      'Email: ayusharyan1309@gmail.com. Phone: +91 8340646275. Location: Hyderabad, Telangana, India. LinkedIn: https://www.linkedin.com/in/ayusharyan1309/. GitHub: https://github.com/ayusharyan1309. LeetCode: https://leetcode.com/u/ayusharyan1309/. GeeksforGeeks: https://auth.geeksforgeeks.org/user/ayusharyan1309/practice.',
  })
  ...
  chunks.push({
    ...
    category: 'Impact',
    content:
      "Ayush's impact metrics: event-driven microservices for platforms supporting 100K+ concurrent users, 10K+ events processed daily, 4 apps shipped to production, 1.5+ years of full-time SDE experience, and 3+ years building products.",
  })
